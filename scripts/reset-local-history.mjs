...
try {
  ...
  store.transaction(() => {
    for (const table of ["approvals", "tool_calls", "run_events", "run_progress", "runs", "tasks", "reactions", "artifacts", "messages", "threads", "goals", "conversation_context", "conversations"])
